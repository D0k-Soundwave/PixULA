...
const SELECTOR = '.tool-btn, .panel-collapse, .layer-ctrl-btn, .panel-header, .app-dialog-close, #zoom-out, #zoom-in, #zoom-fit, .grid-toggle, #touch-mode-status, #zoom-level, .preset-bar-select, .preset-bar-button, .preset-panel-action, .pattern-item, .tp-reset, [data-tp-transform], .tp-xor, .tp-sx, .tp-sy, .tp-rot, .tp-img-rot, .tp-warp, .tp-shift-step, .tp-shift-wrap';
