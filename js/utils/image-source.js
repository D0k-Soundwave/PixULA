...
class ImageSourceClass {
     ...
     *
     * Returns null for every ordinary reason it can fail - moved, renamed,
     * deleted, permission declined - because all of them mean the same thing to
     * the caller: use the thumbnail.
